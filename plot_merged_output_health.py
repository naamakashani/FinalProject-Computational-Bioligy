...
def plot_conf_all_samples(all_samples):
    ...
    fig.savefig('/private/projects/kidney_rtt/all_plots/only_health_plot/conf.png')
...
def count_fusion_for_top_samples(data_list):
    ...
    plt.show()
    fig.savefig(
        '/private/projects/kidney_rtt/all_plots/only_health_plot/count_fusion_for_top_sample.png')
...
def count_fusion_for_sample(data_list):
    ...
    plt.show()
    fig.savefig(
        '/private/projects/kidney_rtt/all_plots/only_health_plot/count_fusion_for_sample.png')
...
def count_fusion_for_gene(data_list):
    ...
    plt.xticks(rotation=90)
    fig.savefig(
        '/private/projects/kidney_rtt/all_plots/only_health_plot/count_fusion_for_gene.png')
...
def count_fusion_for_gene_top(data_list):
    ...
    plt.xticks(rotation=90)
    fig.savefig(
        '/private/projects/kidney_rtt/all_plots/only_health_plot/count_fusion_for_top_gene.png')
...
def site1_site2_filters_read_through(data_list):
    ...
    plt.xticks(rotation=90)
    fig.savefig(
        '/private/projects/kidney_rtt/all_plots/only_health_plot/site1_site2_read_through.png')
    

def main():
    gf_call_list = []
    # Directory path containing the files
    directory = "/private/projects/kidney_rtt/health_samples"
